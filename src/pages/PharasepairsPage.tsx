...
export default function PhrasePairsPage() {
  ...
  // Cargar categorías disponibles para el nivel seleccionado
  useEffect(() => {
      ...
      <div className="min-h-screen relative overflow-x-hidden" style={{ background: '#080810' }}>
        ...
        <div className="relative z-10 px-6 pb-24 max-w-2xl mx-auto">
                ...
                {categories.map((cat) => (
                  <button
                    ...
                    style={{
                      ...
                      background:
                        selectedCat === cat
                          ? LEVEL_COLORS[selectedLevel] + '18'
                          : 'rgba(255,255,255,0.03)',
                      border: `1px solid ${selectedCat === cat ? LEVEL_COLORS[selectedLevel] + '45' : 'rgba(255,255,255,0.07)'}`,
                      color:
                        selectedCat === cat ? LEVEL_COLORS[selectedLevel] : 'rgba(255,255,255,0.3)',
                    }}
                  >
                    {cat}
                  </button>
              ...
              {PAIR_COUNTS.map((n) => (
                <button
                  ...
                  style={{
                    fontSize: 18,
                    background:
                      pairCount === n ? 'rgba(124,92,252,0.18)' : 'rgba(255,255,255,0.02)',
          ...
          <button
            ...
            style={{
              fontSize: 12,
              background: LEVEL_COLORS[selectedLevel] + '18',
              border: `1px solid ${LEVEL_COLORS[selectedLevel]}45`,
              color: LEVEL_COLORS[selectedLevel],
              boxShadow: `0 0 20px ${LEVEL_COLORS[selectedLevel]}15`,
            }}
          >
            ▶ Start · {pairCount} pares
          </button>
        </div>
        ...
        >
          ...
          <span className="font-mono" style={{ color: 'rgba(52,211,153,0.3)', fontSize: 9 }}>
            {selectedLevel.toUpperCase()} · {pairCount} PAIRS
          </span>
        </div>
      </div>
    )
