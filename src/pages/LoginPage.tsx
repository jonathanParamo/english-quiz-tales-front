...
// ── Marco holográfico hecho con Three.js ─────────────────────────────────────
// Puntos en los bordes + líneas de esquina estilo HUD de videojuego
...
function HoloFrame({
  ...
  useFrame((state) => {
    ...
    // Animar puntos — correr por el borde
    if (dotsRef.current) {
      const pos = dotsRef.current.geometry.attributes.position
        ...
        <div className="text-center mb-10">
          <div className="inline-block relative mb-3">
            ...
            <h1
              ...
              style={{
                fontSize: 42,
                background:
                  "linear-gradient(135deg, #e0d7ff 0%, #a78bfa 40%, #34d399 100%)",
            ...
            <h1
              ...
              style={{
                fontSize: 42,
                background:
                  "linear-gradient(135deg, #7c5cfc 0%, #a78bfa 60%, #38bdf8 100%)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
                backgroundClip: "text",
                letterSpacing: "-0.02em",
          ...
          <div className="flex items-center justify-center gap-2 mt-2">
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg,transparent,rgba(124,92,252,0.5))",
              }}
            />
            <span
